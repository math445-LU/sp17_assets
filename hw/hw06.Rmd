...
(a) What distribution does $\dfrac{\sum_{i=1}^n (X_i - \overline{X})}{\sigma^2}$ have?

(b) Why is $\dfrac{\sum_{i=1}^n (X_i - \overline{X})}{\sigma^2}$ a pivotal quantity?
...
$$P\left( c_1 < \dfrac{\sum_{i=1}^n (X_i - \overline{X})}{\sigma^2} < c_2 \right) = 1 - \alpha$$
